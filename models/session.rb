...
class Session
 ...
 def save()
   ...
   (
     name, location, distance, level, day, time_of_day, price, max_number, customers_id
   ...
   RETURNING id"
   values = [@name, @location, @distance, @level, @day, @time_of_day, @price, @max_number, @customers_id]
 ...
 def update
   ...
   values = [@name, @location, @distance, @level, @day, @time_of_day, @price, @max_number, @customer_id, @id]
